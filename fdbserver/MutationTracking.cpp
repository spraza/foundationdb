...
std::vector<std::pair<const char*, KeyRef>> debugKeys = { { "CPKey", "\xff/conf/commit_proxies"_sr } };
std::vector<std::pair<const char*, KeyRangeRef>>
    debugRanges = { /* { "Everything", { ""_sr, "\xff\xff\xff\xff"_sr } } */ };
