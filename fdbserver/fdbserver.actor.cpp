...
int main(int argc, char* argv[]) {
	...
	try {
		...
		// std::cout << "test - arenas active: " << g_arenasActive.load() << std::endl;
		// std::cout << "test - arenas created: " << g_arenasCreated.load() << std::endl;
		// std::cout << "test - arenas destroyed: " << g_arenasDestroyed.load() << std::endl;
