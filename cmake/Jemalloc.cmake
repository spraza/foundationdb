...
ExternalProject_add(Jemalloc_project
  ...
  CONFIGURE_COMMAND CC=${CMAKE_C_COMPILER} CXX=${CMAKE_CXX_COMPILER} ./configure --prefix=${JEMALLOC_DIR} --enable-static --disable-cxx --enable-prof --enable-stats --with-pic --with-malloc-conf=prof:true,lg_prof_sample:0,prof_active:true,prof_final:true,prof_prefix:/var/tmp/fdbserver
  BUILD_IN_SOURCE ON
  BUILD_COMMAND make
