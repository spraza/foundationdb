...
void ServerKnobs::initialize(Randomize randomize, ClientKnobs* clientKnobs, IsSimulated isSimulated) {
	...
	init( DESIRED_TOTAL_BYTES,                                75000  ); if( randomize && BUGGIFY ) DESIRED_TOTAL_BYTES = 10000;
	...
	init( TLOG_SPILL_REFERENCE_MAX_BATCHES_PER_PEEK,             50  ); if ( randomize && BUGGIFY ) TLOG_SPILL_REFERENCE_MAX_BATCHES_PER_PEEK = 1;
