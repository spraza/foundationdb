...
void ServerKnobs::initialize(Randomize randomize, ClientKnobs* clientKnobs, IsSimulated isSimulated) {
	...
	init( SHARD_ENCODE_LOCATION_METADATA,                      false ); SHARD_ENCODE_LOCATION_METADATA = isSimulated; //if( isSimulated ) SHARD_ENCODE_LOCATION_METADATA = deterministicRandom()->random01() < 0.75;
