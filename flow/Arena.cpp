...
void ArenaCounter::inc() {
	g_arenasActive.fetch_add(1, std::memory_order_relaxed);
	g_arenasCreated.fetch_add(1, std::memory_order_relaxed);
}

void ArenaCounter::dec() {
	g_arenasActive.fetch_sub(1, std::memory_order_relaxed);
	g_arenasDestroyed.fetch_add(1, std::memory_order_relaxed);
}
