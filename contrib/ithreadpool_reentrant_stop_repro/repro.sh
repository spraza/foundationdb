#!/usr/bin/env bash
#
# Reproduces a ThreadPool::stop() reentrancy crash triggered by fdbcli>
# suspend against a real 2-region HA cluster under load. See README.md in
# this directory for the full explanation of the bug and the mechanism.
#
# Usage:
